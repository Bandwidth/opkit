 ...
 *{              
 *	command : function(message, bot, auth) //Will be called when the command is run.
 *  names : [String] //The keywords that should be listened for.
 *  				 //The command will be run whenever any of these words are the second word of the message.
 *  roles : [String] //An optional list of roles. If present, whenever the command is run, the authorizationFunction
 *                   //is run, and the lists of roles compared.
 *}
