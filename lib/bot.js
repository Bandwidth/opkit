...
function OpkitBot(name, cmds, persister, params) {
	...
	if (this.logLevel === 'DEBUG'){
		this.rtm = new RtmClient(this.token, {useRtmConnect: true, dataStore : self.dataStore, logLevel : 'debug'});
	} else {
		this.rtm = new RtmClient(this.token, {useRtmConnect: true, dataStore : self.dataStore});
	}
