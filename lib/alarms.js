 ...
 */
Alarms.prototype.getAllAlarms = function(auth, params, prevResults){
	var self = this;
	params = params || {};
	prevResults = prevResults || null;
	...
	.then(function(data) {
		...
		if (data.NextToken) {
			...
			return self.getAllAlarms(auth, params, data);
		} else {
...
Alarms.prototype.queryAlarmsByState = function(state, auth){
	return this.getAllAlarms(auth, {StateValue : state});
};
/**
 * Queries Cloudwatch alarms that are currently in a particular state.
...
Alarms.prototype.queryAlarmsByWatchlist = function(watchlist, auth){
	return this.getAllAlarms(auth, {AlarmNames: watchlist});
};
...
Alarms.prototype.queryAlarmsByPrefix = function(prefix, auth){
	return this.getAllAlarms(auth, {AlarmNamePrefix: prefix});
};
