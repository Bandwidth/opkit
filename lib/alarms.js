...
*/
Alarms.prototype.queryAlarmsByState = function(state){
	cloudwatch = new AWS.cloudWatch(Auth.props);
...
Alarms.prototype.queryAlarmsByStateReadably = function(state){
	cloudwatch = new AWS.cloudWatch(Auth.props);
...
Alarms.prototype.countAlarmsByState = function(state){
	cloudwatch = new AWS.cloudWatch(Auth.props);
	return this.queryAlarmsByState(state)
	.then(function(data){
		var alarms = data.MetricAlarms;
...
Alarms.prototype.healthReportByState = function(){
	cloudwatch = new AWS.cloudWatch(Auth.props);	
